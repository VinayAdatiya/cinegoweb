...
public class ShowPriceCategoryDAOImpl implements IShowPriceCategoryDAO {
    @Override
    public void addShowPriceCategory(int showId, List<ShowPriceCategory> priceCategories, int currentUserId, Connection connection) throws DBException {
        String query = "INSERT INTO show_price_category (show_id, seat_category_id, price, created_by, updated_by) " +
                "VALUES (?, ?, ?, ?, ?)";
    ...
    public void updateShowPriceCategory(int showId, List<ShowPriceCategory> showPriceCategoryList, int currentUserId, Connection connection) throws DBException {
        try {
            ...
            addShowPriceCategory(showId, showPriceCategoryList, currentUserId, connection);
    ...
    public List<ShowPriceCategory> getShowPriceCategoriesByShow(int showId) throws DBException {
        String query = "SELECT spc.show_id, spc.seat_category_id, spc.base_price, sc.seat_type " +
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                showPriceCategory.getShow().setShowId(resultSet.getInt("show_id"));
